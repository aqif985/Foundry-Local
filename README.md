...
Welcome to Foundry Local! This application allows you to run Generative AI models right on your computer, without needing any cloud services or an Azure subscription. It keeps your data safe by processing everything locally.
...
## ⚙️ Running Foundry Local

After installing, you can start Foundry Local by following these steps:

1. Locate the Foundry Local icon on your desktop or in your applications folder.
2. Double-click the icon to launch the application.
3. Wait for the application to initialize. This may take a moment.
4. Once loaded, follow the on-screen prompts to set up your first AI model.

## 📚 Using Foundry Local

Foundry Local is designed to be user-friendly. It guides you through using AI models with simple steps. Here are some key features:

- **Model Selection:** Choose from a variety of AI models designed for different tasks.
- **Local Processing:** All data stays on your device. There’s no need to worry about privacy.
- **User Guide:** Built-in help documentation to assist you at any stage.
...
Your feedback is essential for us. Please share your thoughts or suggest features by creating an issue in the GitHub repository or in our Discord channel.
